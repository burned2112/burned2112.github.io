...
import {
    AddCircleOutlineOutlined, AssessmentRounded,
...
import ModalAddForm from "./AddReport";
...
function ReportList() {
    ...
    return (
        ...
        <Grid container>
            <Grid xs={2} >
                <Paper xs={12} md={12} sx={{ width: '100%', minHeight: "96%", overflow: 'hidden', pl: 1, pr: 1}}>
                    1
                </Paper>
            </Grid>
            <Grid xs={10}>
                <Paper xs={12} sx={{ width: '100%', minHeight: "17%", overflow: 'hidden', pt: 1, pl: 5, pr: 1}}>
                    <Paper elevation={2} sx={{maxWidth: '100px', height: '70px', float: 'left', mr: 2, padding: 2}} align={'center'}>
                        <AssessmentRounded sx={{color: 'rgb(21, 6, 64, 0.8)',fontSize: '40px'}} color={'primary'}/>
                    </Paper>
                    <Typography
                        variant={"h6"}
                        component={"div"}
